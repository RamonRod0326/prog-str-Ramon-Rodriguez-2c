...
public class Main {
    ...
    /**
     * * Metodo para obtener un numero double desde la consola * @param sc ->
     * objeto previamente instanciado * @param mensaje -> mensaje a mosntrar en
     * consola * @return
     */
    ...
    /**
     * * Metodo para calcular y devolver el IMC con con formula peso/altura al
     * cuadrado * @param pesoKg -> expresado en KG (80) * @param alturaM ->
     * expresado en M (1.80) * @return -> double IMC
     */
    ...
    /**
     * * Metodo que devuelve la clasificación basada en el IMC * @param IMC ->
     * previamente calculado * @return String clasificacion
     */
